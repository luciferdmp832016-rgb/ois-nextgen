...
check_app "OIS_CONSOLE" "apps/ois-console" "/" "/product-flow" "/dashboard" "/products" "/products/[id]" "/workspaces" "/workspaces/[id]" "/modules/[id]" "/installations/[id]" "/learning-center" "/knowledge-fabric" "/localization" "/runtime"
...
printf '\nUI_ROUTE_MANIFEST_CHECK_PASSED OIS Console and PITS Shell Stage 1A/1C plus Stage 2A workboard, Stage 2B work item detail, Stage 2D localized product-flow routes, Stage 2D-R1 localization catalog routes, Stage 2E action-request panel route, Stage 2F Learning Center route and Stage 2G Knowledge Fabric route are present in production build artifacts.\n'
