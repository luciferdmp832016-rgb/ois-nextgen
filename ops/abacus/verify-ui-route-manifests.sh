...
check_app "OIS_CONSOLE" "apps/ois-console" "/" "/product-flow" "/dashboard" "/products" "/products/[id]" "/workspaces" "/workspaces/[id]" "/modules/[id]" "/installations/[id]" "/localization" "/runtime"
