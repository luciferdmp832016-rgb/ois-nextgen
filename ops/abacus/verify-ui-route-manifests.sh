...
check_app "PITS_SHELL" "apps/pits-shell" "/" "/projects" "/projects/[id]" "/projects/[id]/workboard" "/projects/[id]/work-items/[itemId]" "/runtime"
...
printf '\nUI_ROUTE_MANIFEST_CHECK_PASSED OIS Console and PITS Shell Stage 1A/1C plus Stage 2A workboard and Stage 2B work item detail routes are present in production build artifacts.\n'
