...
printf 'Runtime topology: Core API stays unchanged at %s; OIS Console port 3000; PITS Shell port 3001; OIMA Shell port 3002.\n' "$CORE_API_URL"
...
if [ "$BUILD_UI_DEMO_SHELLS" = "true" ]; then
  ...
  ui_demo_build_shell "@ois/oima-shell" "OIMA_SHELL"
else
...
ui_demo_start_shell "oima-shell" "OIMA_SHELL" "@ois/oima-shell" "3002"
...
ui_demo_wait_for_local "UI_DEMO_LOCAL_READY" "OIMA_SHELL_LOCAL" "http://127.0.0.1:3002/" "OIMA_APP_SHELL" "OIMA"

printf '%s\n' "UI_DEMO_START_VERIFICATION_PASSED OIS Console, PITS Shell and OIMA Shell local demo pages are ready."
