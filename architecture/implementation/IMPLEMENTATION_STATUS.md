...
| CANONICAL_KNOWLEDGE_FABRIC_KEIHB_LAYER_INTEGRATION | CANONICAL_KNOWLEDGE_FABRIC_KEIHB_LAYER_INTEGRATION_READY | Stage 2G adds the Canonical Knowledge Fabric and KEIHB projection foundation: KL-0 through KL-5 taxonomy, canonical knowledge items, evidence links, Learning Candidate to Knowledge Layer mappings, KEIHB bundle projections, deterministic knowledge context routes, OIS `/knowledge-fabric`, Learning Center integration and the architecture mindmap manifest. It uses ADR `0005`, versioned migration `202607090002_stage_2g_canonical_knowledge_fabric_keihb`, local non-production DB validation and keeps auto-promotion disabled. |
