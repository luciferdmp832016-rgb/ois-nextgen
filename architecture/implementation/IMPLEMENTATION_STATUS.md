...
| KNOWLEDGE_VERTICAL_SLICE | FOUNDATION_STARTED_NO_CANONICAL_WRITE | Stage 2F starts the governed learning foundation through signals, candidates, policies and agent submissions, but canonical Knowledge, Wisdom and Intelligence promotion remains blocked until later ADRs, rollback tests and owner-approved promotion gates exist. |
