...
| OIS Console SuperComputer product subdomain root | `https://ois-ng.dmp247.com` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | DNS CNAME and local Host-header routing passed; public HTTPS needs Abacus custom hostname/TLS registration. Do not touch `ois.dmp247.com`. |
| PITS Shell SuperComputer product subdomain root | `https://pits-ng.dmp247.com` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | DNS CNAME and local Host-header routing passed; public HTTPS needs Abacus custom hostname/TLS registration. |
| OIS Console SuperComputer product subdomain dashboard | `https://ois-ng.dmp247.com/dashboard` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | Local host route works, but public HTTPS path fails SSL handshake until Abacus edge/TLS registration is resolved. |
| PITS Shell SuperComputer product subdomain projects | `https://pits-ng.dmp247.com/projects` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | Local host route works, but public HTTPS path fails SSL handshake until Abacus edge/TLS registration is resolved. |
...
| OIS product subdomain root | `https://ois-ng.dmp247.com` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | DNS CNAME and local Host-header routing passed; public HTTPS SSL handshake fails and HTTP root returns 409. Requires Abacus custom hostname/TLS registration check. |
| PITS product subdomain root | `https://pits-ng.dmp247.com` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | DNS CNAME and local Host-header routing passed; public HTTPS SSL handshake fails and HTTP root returns 409. Requires Abacus custom hostname/TLS registration check. |
| OIS product subdomain dashboard | `https://ois-ng.dmp247.com/dashboard` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | Local routing is not the blocker; public HTTPS path fails until Abacus edge/TLS registration is resolved. |
| PITS product subdomain projects | `https://pits-ng.dmp247.com/projects` | `CUSTOM_SUBDOMAIN_TLS_BLOCKED` | Local routing is not the blocker; public HTTPS path fails until Abacus edge/TLS registration is resolved. |
