...
| OIS Console products route | `https://ois-ng.dmp247.com/products` | `BLOCKED` | Stage 1A Abacus runtime verification returned local/public HTTP 404; Stage 1A-R1 hotfix is ready and owner runtime re-sync is required before public HTTP 200 can be claimed. |
| OIS Console workspaces route | `https://ois-ng.dmp247.com/workspaces` | `BLOCKED` | Stage 1A Abacus runtime verification returned local/public HTTP 404; Stage 1A-R1 hotfix is ready and owner runtime re-sync is required before public HTTP 200 can be claimed. |
| OIS Console runtime route | `https://ois-ng.dmp247.com/runtime` | `BLOCKED` | Stage 1A Abacus runtime verification returned local/public HTTP 404; Stage 1A-R1 hotfix is ready and owner runtime re-sync is required before public HTTP 200 can be claimed. |
| PITS Shell runtime route | `https://pits-ng.dmp247.com/runtime` | `BLOCKED` | Stage 1A Abacus runtime verification returned local/public HTTP 404; Stage 1A-R1 hotfix is ready and owner runtime re-sync is required before public HTTP 200 can be claimed. |
...
| OIS Console products route after Stage 1A-R1 sync | `curl -i https://ois-ng.dmp247.com/products` | HTTP 200 OIS Products & Modules route. |
| OIS Console workspaces route after Stage 1A-R1 sync | `curl -i https://ois-ng.dmp247.com/workspaces` | HTTP 200 OIS Workspaces route. |
| OIS Console runtime route after Stage 1A-R1 sync | `curl -i https://ois-ng.dmp247.com/runtime` | HTTP 200 OIS Runtime Status route. |
| PITS Shell runtime route after Stage 1A-R1 sync | `curl -i https://pits-ng.dmp247.com/runtime` | HTTP 200 PITS Runtime Status route. |
