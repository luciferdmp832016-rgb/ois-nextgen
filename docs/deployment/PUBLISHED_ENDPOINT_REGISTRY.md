...
| OIS Console products route | `https://ois-ng.dmp247.com/products` | `PLANNED_NOT_CREATED` | Stage 1A source route and endpoint check ready; owner runtime sync required before public verification. |
| OIS Console workspaces route | `https://ois-ng.dmp247.com/workspaces` | `PLANNED_NOT_CREATED` | Stage 1A source route and endpoint check ready; owner runtime sync required before public verification. |
| OIS Console runtime route | `https://ois-ng.dmp247.com/runtime` | `PLANNED_NOT_CREATED` | Stage 1A source route and endpoint check ready; owner runtime sync required before public verification. |
| PITS Shell runtime route | `https://pits-ng.dmp247.com/runtime` | `PLANNED_NOT_CREATED` | Stage 1A source route and endpoint check ready; owner runtime sync required before public verification. |
...
| Stage 1A | `https://ois-ng.dmp247.com` | `PLANNED_NOT_CREATED` | Source changes root from demo/status page to OIS Console product administration overview. | Verify after owner runtime sync. |
| Stage 1A | `https://ois-ng.dmp247.com/dashboard` | `PLANNED_NOT_CREATED` | Source changes dashboard to product-shell Platform Overview dashboard. | Verify after owner runtime sync. |
| Stage 1A | `https://ois-ng.dmp247.com/products` | `PLANNED_NOT_CREATED` | New OIS Console products route. | Verify after owner runtime sync. |
| Stage 1A | `https://ois-ng.dmp247.com/workspaces` | `PLANNED_NOT_CREATED` | New OIS Console workspaces route. | Verify after owner runtime sync. |
| Stage 1A | `https://ois-ng.dmp247.com/runtime` | `PLANNED_NOT_CREATED` | New OIS Console runtime route. | Verify after owner runtime sync. |
| Stage 1A | `https://pits-ng.dmp247.com` | `PLANNED_NOT_CREATED` | Source changes root from demo/status page to PITS project runtime overview. | Verify after owner runtime sync. |
| Stage 1A | `https://pits-ng.dmp247.com/projects` | `PLANNED_NOT_CREATED` | Source changes projects route to product-shell Project Selector baseline. | Verify after owner runtime sync. |
| Stage 1A | `https://pits-ng.dmp247.com/runtime` | `PLANNED_NOT_CREATED` | New PITS runtime route. | Verify after owner runtime sync. |
...
| OIS Console products route after Stage 1A sync | `curl -i https://ois-ng.dmp247.com/products` | HTTP 200 OIS Products & Modules route. |
| OIS Console workspaces route after Stage 1A sync | `curl -i https://ois-ng.dmp247.com/workspaces` | HTTP 200 OIS Workspaces route. |
| OIS Console runtime route after Stage 1A sync | `curl -i https://ois-ng.dmp247.com/runtime` | HTTP 200 OIS Runtime Status route. |
| PITS Shell runtime route after Stage 1A sync | `curl -i https://pits-ng.dmp247.com/runtime` | HTTP 200 PITS Runtime Status route. |
