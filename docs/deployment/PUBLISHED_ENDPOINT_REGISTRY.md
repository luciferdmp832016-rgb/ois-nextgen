...
| Knowledge layer mappings API after Stage 2G-R1 sync | `curl -i https://ois-nextgen.abacusai.cloud/platform/learning/layer-mappings` | HTTP 200 with `knowledgeLayerTaxonomy`, `availableLayers`, `KL_0_LEGAL_REGULATORY_CORE`, candidate-to-layer mappings and `READY_FOR_REVIEW`. |
