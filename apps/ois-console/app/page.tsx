...
const productCode = "OIS_CONSOLE";
const appShellName = "OIS Console";
    ...
    <main className="demo-shell">
      <section className="hero-panel">
        <div>
          ...
          <h1>{appShellName}</h1>
          <p className="muted">
            Product administration shell demo reading seeded Platform Kernel status through the shared Core API.
          </p>
        </div>
        <StatusBadge ok={health.ok && healthStatus === "ok"} label={health.ok ? "Core API healthy" : "Core API unavailable"} />
      </section>

      <section className="detail-grid" aria-label="OIS Console demo status">
        <div className="panel">
          <h2>App Shell</h2>
          <dl className="facts">
            <div>
      ...
      <section className="panel" aria-label="Platform overview counts">
